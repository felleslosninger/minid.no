...
- To use the MinID app on mobile, you need to download the app from Google Play or the App Store. [Get started with MinID app.](https://minid.no/en/get-started/minid-app/)
